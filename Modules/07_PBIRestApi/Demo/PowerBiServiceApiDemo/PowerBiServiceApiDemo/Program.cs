...
class Program {
  ...
  static string GetAccessToken() {
    ...
    //authenticationContext.AcquireTokenAsync(resourceUriPowerBi,
    //                                        clientId,
    //                                        new UserPasswordCredential("CriticalPathUser300@PowerBiMvps.onMicrosoft.com",
    //                                                                   "Yourpassword")).Result;
  ...
  static void Main() {
    ...
    //PublishPBIX(@"C:\Student\PBIX\Wingtip Sales Report.pbix", "Sales Report");
    //PatchDatasourceCredentials("Sales Report", "CptStudent", "pass@word1");
    //RefreshDataset("Sales Report");

    //PublishPBIX(@"C:\Student\PBIX\Wingtip Sales DirectQuery.pbix", "Wingtip Sales DQ");
    //PatchDatasourceCredentials("Wingtip Sales DQ", "CptStudent", "pass@word1");

    //CreateAppWorkspace("Customer A");
    
    //CloneAppWorkspace("Customer A", "Customer B");
  }
